        ...
        function (data) {
            $.each(data, function (i, item) {
                ...
                /*$("#input_count_" + item.id).on("change", function (obj) {
                    //$("#input_count_label_" + item.id).text(obj.value.newValue);
                    $("#input_count_label_" + item.id).val(obj.value.newValue);
                });
                $("#input_count_" + item.id).on("slideStop", function (obj) {
                    loadOrderInfo();
                });
                $("#input_count_label_" + item.id).on("change", function () {
                    var count = $("#input_count_label_" + item.id).val();
                    $("#input_count_" + item.id).val(count);
                    $("#input_count_" + item.id).slider({
                        value: count,
                    });
                    a = $("#input_count_" + item.id);
                });*/
                $("#input_count_" + item.id).on("change", function (obj) {
                    loadOrderInfo();
                });
