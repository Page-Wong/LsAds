...
using LsAdmin.Utility.Services.WebSocketService.Common;
...
namespace LsAdmin.Utility.Services.WebSocketService
{
    public abstract class WebSocketHandler {
        ...
        public virtual async Task OnConnected(HttpContext context, WebSocket socket) {
