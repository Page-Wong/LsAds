...
namespace LsAdmin.Utility.SMS {
    public class SmsSingleSender {
        int sdkappid = 1400053683;
        string appkey = "713024ca413697492c13493f8c9179e1";
        ...
        public SmsSingleSenderResult SendCode(string phoneNumber, string smsCode) {
            SmsSingleSenderResult singleResult = null;
            try {
                SmsSingleSender singleSender = new SmsSingleSender();
                string templateParam = "您的验证码为"+ smsCode + "，5分钟内有效！";
                singleResult = singleSender.Send(0, "86", phoneNumber, templateParam, "", "");
            }
            catch (Exception e) {
                Console.WriteLine(e);
            }
        ...
        public SmsSingleSenderResult Send(
            ...
            */
            ...
            long curTime = TimeConvertHelper.GetTimeStamp();
